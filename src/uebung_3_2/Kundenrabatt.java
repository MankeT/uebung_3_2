...
public class Kundenrabatt {
	...
	public static void main(String[] args) {
		...
		System.out.println("Der Bestellwert beträgt " + bestellwert + " Euro.");
		System.out.println("Das bisherige Bestellvolumen beträgt " + bisherigesKundenBestellvolumen + " Euro.");
